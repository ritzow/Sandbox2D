...
public final class EntityController implements Controller, KeyHandler {
	...
	public void update() {
		if(left) {
			...
			else if(!blockLeft(entity.getPositionX(), entity.getPositionY() + getJumpHeight(((ClientWorld)world).getGravity()), entity.getWidth(), entity.getHeight()) && canJump()) {
			...
			else if(!blockRight(entity.getPositionX(), entity.getPositionY() + getJumpHeight(((ClientWorld)world).getGravity()), entity.getWidth(), entity.getHeight()) && canJump()) {
				entity.setVelocityY(movementSpeed);
			}
		}

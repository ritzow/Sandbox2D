...
layout(location = 1) uniform uvec4 blockGrid; //left block X, bottom blockY, blocks width, blocks height

const int MAX_RENDER_COUNT = 600; //will need to pad each draw call by a certain number of blocks if not start of row ie just set the first offset to not be 0.

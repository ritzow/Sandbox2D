...
public class AsyncClient implements GameTalker {
...
//	}
	 ...
	 */
	public static AsyncClient connect(InetSocketAddress bindAddress, InetSocketAddress serverAddress, Executor runner)
			throws IOException, ConnectionFailedException {
		return new AsyncClient(bindAddress, serverAddress, runner);
	}

	private AsyncClient(InetSocketAddress bindAddress, InetSocketAddress serverAddress, Executor runner) throws ConnectionFailedException, IOException {
		this.runner = runner;

...
public interface Control {
	...
	Button UI_BACKSPACE =       new Button(BUTTON_TYPE_KEYBOARD, GLFW_KEY_BACKSPACE);
	Button UI_DELETE =          new Button(BUTTON_TYPE_KEYBOARD, GLFW_KEY_DELETE);
	Button UI_CONFIRM =         new Button(BUTTON_TYPE_KEYBOARD, GLFW_KEY_ENTER);

...
public class Control {
	...
	public static final Button INCREASEZOOM = 	new Button(Button.TYPE_KEYBOARD,  GLFW_KEY_KP_ADD);
	public static final Button DECREASEZOOM = 	new Button(Button.TYPE_KEYBOARD,  GLFW_KEY_KP_SUBTRACT);
